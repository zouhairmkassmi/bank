...
public class TransactionResourceIntTest {
    ...
    private static final String DEFAULT_REF_T = "AAAAAAAAAA";
    private static final String UPDATED_REF_T = "BBBBBBBBBB";
    ...
    public void createTransaction() throws Exception {
        ...
        assertThat(testTransaction.getRefT()).isEqualTo(DEFAULT_REF_T);
    ...
    public void getAllTransactions() throws Exception {
        ...
        restTransactionMockMvc.perform(get("/api/transactions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].refT").value(hasItem(DEFAULT_REF_T.toString())))
            .andExpect(jsonPath("$.[*].montant").value(hasItem(DEFAULT_MONTANT.intValue())))
            .andExpect(jsonPath("$.[*].date").value(hasItem(DEFAULT_DATE.toString())));
    }
    
    public void getAllTransactionsWithEagerRelationshipsIsEnabled() throws Exception {
        TransactionResource transactionResource = new TransactionResource(transactionServiceMock);
    ...
    public void getTransaction() throws Exception {
        ...
        restTransactionMockMvc.perform(get("/api/transactions/{id}", transaction.getId()))
            ...
            .andExpect(jsonPath("$.refT").value(DEFAULT_REF_T.toString()))
    ...
    public void updateTransaction() throws Exception {
        ...
        Transaction testTransaction = transactionList.get(transactionList.size() - 1);
        assertThat(testTransaction.getRefT()).isEqualTo(UPDATED_REF_T);
