...
public class ProduitResourceIntTest {
    ...
    private static final Long DEFAULT_QUANTITE_DISPONIBLE = 1L;
    private static final Long UPDATED_QUANTITE_DISPONIBLE = 2L;
    ...
    public void createProduit() throws Exception {
        ...
        assertThat(testProduit.getQuantiteDisponible()).isEqualTo(DEFAULT_QUANTITE_DISPONIBLE);
        assertThat(testProduit.getPicture()).isEqualTo(DEFAULT_PICTURE);
        assertThat(testProduit.getPictureContentType()).isEqualTo(DEFAULT_PICTURE_CONTENT_TYPE);
    }
    ...
    public void getAllProduits() throws Exception {
        ...
        restProduitMockMvc.perform(get("/api/produits?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].quantiteDisponible").value(hasItem(DEFAULT_QUANTITE_DISPONIBLE.intValue())))
    ...
    public void getProduit() throws Exception {
        ...
        restProduitMockMvc.perform(get("/api/produits/{id}", produit.getId()))
            ...
            .andExpect(jsonPath("$.quantiteDisponible").value(DEFAULT_QUANTITE_DISPONIBLE.intValue()))
    ...
    public void updateProduit() throws Exception {
        ...
        assertThat(testProduit.getQuantiteDisponible()).isEqualTo(UPDATED_QUANTITE_DISPONIBLE);
        assertThat(testProduit.getPicture()).isEqualTo(UPDATED_PICTURE);
        assertThat(testProduit.getPictureContentType()).isEqualTo(UPDATED_PICTURE_CONTENT_TYPE);
    }
