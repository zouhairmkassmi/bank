    ...
    describe('Contrat Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/contrats';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Contrat', () => {
                service.create(new Contrat(null)).subscribe(received => {
            ...
            it('should update a Contrat', () => {
                service.update(new Contrat(123)).subscribe(received => {
