    ...
    describe('Produit Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Produit', () => {
                service.create(new Produit(null)).subscribe(received => {
            ...
            it('should update a Produit', () => {
                service.update(new Produit(123)).subscribe(received => {
