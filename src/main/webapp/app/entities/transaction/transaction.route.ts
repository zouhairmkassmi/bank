...
export class TransactionResolve implements Resolve<ITransaction> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        if (id) {
            return this.service.find(id).map((transaction: HttpResponse<Transaction>) => transaction.body);
        }
        return Observable.of(new Transaction());
    }
}
...
export const transactionRoute: Routes = [
    {
        ...
        data: {
            ...
            pageTitle: 'bankApp.transaction.home.title'
        },
