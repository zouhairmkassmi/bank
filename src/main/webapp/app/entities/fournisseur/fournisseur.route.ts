...
export class FournisseurResolve implements Resolve<IFournisseur> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        if (id) {
            return this.service.find(id).map((fournisseur: HttpResponse<Fournisseur>) => fournisseur.body);
        }
        return Observable.of(new Fournisseur());
    }
}
...
export const fournisseurRoute: Routes = [
    {
        ...
        data: {
            ...
            pageTitle: 'bankApp.fournisseur.home.title'
        },
