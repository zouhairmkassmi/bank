...
import com.bank.service.CategorieService;
import com.bank.domain.Categorie;
import com.bank.repository.CategorieRepository;
...
public class CategorieServiceImpl implements CategorieService {
    ...
    public Categorie save(Categorie categorie) {
        log.debug("Request to save Categorie : {}", categorie);        return categorieRepository.save(categorie);
    }
